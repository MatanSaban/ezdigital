...
const SingleProject = (props) => {
    ...
    return (
        <>
            <Head>
				<title>{project?.acf?.project_name}</title>
                <meta property="og:title" content={project?.acf?.project_name} />
                <meta property="og:description" content={project?.acf?.short_description_about_client}/>
                <meta property="og:image" content={project?.acf?.first_background?.url}/>
            </Head>
